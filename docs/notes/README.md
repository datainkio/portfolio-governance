...
TODO: Refine Agent Roles and Workflows: Update docs/agent-roles-and-workflows.md to explicitly limit to non-coding tasks. For example, redefine "planner" as "hygiene planner" focused on organizing specs/docs.
...
TODO: Boost AIX Perf Configurations: Add an AIX performance checklist doc for agents to follow, including steps to monitor AI token usage or context overload.
...
TODO: Monitoring and Feedback Loops: Introduce a simple hygiene log template for agents to record maintenance actions. Suggest periodic AIX benchmarks (e.g., manual timing of AI queries) to ensure ongoing performance.
