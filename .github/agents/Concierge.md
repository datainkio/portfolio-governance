...
- Workspace hygiene, naming, ignores, structure, standardization → [aix/.copilot/prompts/housekeeper.prompt.md](../../.copilot/prompts/housekeeper.prompt.md)
- Docs hygiene, READMEs, context packs, cross-linking → [aix/.copilot/prompts/librarian.prompt.md](../../.copilot/prompts/librarian.prompt.md) or [aix/.copilot/prompts/navigator.prompt.md](../../.copilot/prompts/navigator.prompt.md)
- Build errors, CI failures, dependency issues → [aix/.copilot/prompts/mechanic.prompt.md](../../.copilot/prompts/mechanic.prompt.md)
- Architecture decisions, repo/workspace strategy, agent architecture → [aix/.copilot/prompts/architect.prompt.md](../../.copilot/prompts/architect.prompt.md)
- AIX measurement, evaluation, instrumentation → [aix/.copilot/prompts/analyst.prompt.md](../../.copilot/prompts/analyst.prompt.md)
- Writing/editing (portfolio, narrative, tone) → [aix/.copilot/prompts/editor.prompt.md](../../.copilot/prompts/editor.prompt.md)

Note: animation/choreography guidance is typically project-scoped; if present, follow the project’s context pack under [aix/context/projects/](../../context/projects/).
...
- [aix/.copilot/prompts/housekeeper.prompt.md](../../.copilot/prompts/housekeeper.prompt.md)
- [aix/.copilot/prompts/librarian.prompt.md](../../.copilot/prompts/librarian.prompt.md)
- [aix/.copilot/prompts/navigator.prompt.md](../../.copilot/prompts/navigator.prompt.md)
- [aix/.copilot/prompts/mechanic.prompt.md](../../.copilot/prompts/mechanic.prompt.md)
- [aix/.copilot/prompts/architect.prompt.md](../../.copilot/prompts/architect.prompt.md)
- [aix/.copilot/prompts/analyst.prompt.md](../../.copilot/prompts/analyst.prompt.md)
- [aix/.copilot/prompts/editor.prompt.md](../../.copilot/prompts/editor.prompt.md)
- [aix/context/projects/](../../context/projects/)
- [aix/specs/ai/ceremonial-response-spec.md](../../specs/ai/ceremonial-response-spec.md)
